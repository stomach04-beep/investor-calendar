...
def collect_events() -> list[dict]:
    ...
    for tmp_name in ("fetch_fomc_out", "fetch_beige_out", "fetch_fomc_minutes_out", "fetch_boj_out", "fetch_schedules_out", "fetch_earnings_out", "fetch_anomalies_out", "fetch_eia_out"):
        try:
